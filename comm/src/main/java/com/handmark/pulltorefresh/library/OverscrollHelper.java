...
public final class OverscrollHelper {
	 ...
	 * <p/>
	 * This should only be used on AdapterView's such as ListView as it just calls through to overScrollBy() with the scrollRange = 0. AdapterView's do not have
	 * a scroll range (i.e. getScrollY() doesn't work).
	 * 
	 * @param view
	...
	/**
	 * Helper method for Overscrolling that encapsulates all of the necessary function. This version of the call is used for Views that need to specify a Scroll
	 * Range but scroll back to it's edge correctly.
	 * 
	 * @param view
	 *            - PullToRefreshView that is calling this.
	 * @param deltaX
	 ...
	 *            - Threshold for which the values how fuzzy we should treat the other values. Needed for WebView as it doesn't always scroll back to it's edge.
	 *            0 = no fuzziness.
	 * @param scaleFactor
