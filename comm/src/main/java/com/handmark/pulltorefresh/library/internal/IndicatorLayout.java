...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		Drawable arrowD = context.getApplicationContext().getResources().getDrawable(R.mipmap.pull_indicator_arrow);
		mArrowImageView.setImageDrawable(arrowD);

		final int padding = context.getApplicationContext().getResources().getDimensionPixelSize(R.dimen.indicator_internal_padding);
