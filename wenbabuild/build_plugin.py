...
class PluginBuilder():
    ...
    def parseManifestFile(self):
        ...
        found = re.search(r'package="(com\.xun\.holyplugindemo\.[^"]+)"', contents)
        if not found:
    ...
    def parseBuildProp(self):
        ...
        includeSrcDir = 'src/main/java/com/xun/holyplugindemo/' + pluginPackageName
    ...
    def proguard(self):
        ...
        cmd = ' -jar ' + self.sdkDir + '/tools/proguard/lib/proguard.jar ' \
              ...
              + ' @proguard-rules.pro' \
              + ' -dontnote ' \
              + ' -keep class com.wenba.bangbang.' + pluginPackageName + '.LauncherPlugin'
