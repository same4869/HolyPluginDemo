...
import com.xun.holyplugindemo.pluginbase.update.PluginUpdateInfoList;
...
import com.xun.holyplugindemo.pluginbase.utils.StreamUtils;
...
public class PluginUpdateManager {
    ...
    private static void downloadPlugin(Context hostContext, PluginUpdateInfoList.PluginUpdateInfo info) {
        ...
        BBLog.e(TAG, "插件下载：" + info.getPluginName() + " ,downloadPath=" + downloadPath);
