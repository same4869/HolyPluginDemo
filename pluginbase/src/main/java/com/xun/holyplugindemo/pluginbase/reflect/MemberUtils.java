...
package com.xun.holyplugindemo.pluginbase.reflect;
...
class MemberUtils {
    ...
    static boolean isAssignable(Class<?>[] classArray, Class<?>[] toClassArray, final boolean autoboxing) {
        if (com.xun.holyplugindemo.pluginbase.reflect.Utils.isSameLength(classArray, toClassArray) == false) {
            return false;
        }
        if (classArray == null) {
            classArray = com.xun.holyplugindemo.pluginbase.reflect.Utils.EMPTY_CLASS_ARRAY;
        }
        if (toClassArray == null) {
            toClassArray = com.xun.holyplugindemo.pluginbase.reflect.Utils.EMPTY_CLASS_ARRAY;
        }
