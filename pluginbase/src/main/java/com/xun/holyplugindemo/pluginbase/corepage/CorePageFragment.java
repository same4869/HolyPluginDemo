...
//		refWatcher.watch(this);
	...
	public void printStash(){
		BBLog.e("ljj", this.getPageName()+" isAdded:"+this.isAdded());
		BBLog.e("ljj", this.getPageName()+" isHidden:"+this.isHidden());
		BBLog.e("ljj", this.getPageName()+" isDetached:"+this.isDetached());
		BBLog.e("ljj", this.getPageName()+" isInLayout:"+this.isInLayout());
		BBLog.e("ljj", this.getPageName()+" isResumed:"+this.isResumed());
		BBLog.e("ljj", this.getPageName()+" isRemoving:"+this.isRemoving());
		BBLog.e("ljj", this.getPageName()+" isVisible:"+this.isVisible());
	}
